...
namespace Laba13
{
    public class HTAFileManager
    {
        ...
        public static void InspectDrive(string driveName)
        {
            ...
            using (StreamWriter streamWriter = new StreamWriter(@"d:\Образование\3Semester\OOP\OOP1Semestr\Laba13\Laba13\HTAInspect\HTAdirinfo.txt"))
            {
                streamWriter.WriteLine("|Directories| [");
                foreach (var directoryInfo in currentDrive.RootDirectory.GetDirectories())
                {
                ...
                foreach (var fileInfo in currentDrive.RootDirectory.GetFiles())
                {
            ...
            File.Copy(@"d:\Образование\3Semester\OOP\OOP1Semestr\Laba13\Laba13\HTAInspect\HTAdirinfo.txt",@"d:\Образование\3Semester\OOP\OOP1Semestr\Laba13\Laba13\HTAInspect\HTAdirinfoCopy.txt",true);
        ...
        public static void CopyFiles(string path, string extension)
        {
            ...
            Directory.Move(@"d:\Образование\3Semester\OOP\OOP1Semestr\Laba13\Laba13\HTAFiles\", @"d:\Образование\3Semester\OOP\OOP1Semestr\Laba13\Laba13\HTAInspect\HTAFiles\");
        }
